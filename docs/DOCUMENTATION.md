...
**All documentation for Website Monitor Testmo**
...
- **[docs/security/SECURITY_CONFIG.md](security/SECURITY_CONFIG.md)** - Security configuration guide
...
- **config/websites.json** - Website configuration (see main README.md)
...
- **Setup Guide**: [docs/setup/SETUP_AND_USAGE.md](setup/SETUP_AND_USAGE.md)
